...
export const handelUserInfo = (user: User): User => {
  ...
  user.fullhead = `${YGURL.asset_url}${user.head}`
  user.sexName = sex2Name(Number(user.sex))
  user.utypeName = utype2Name(Number(user.utype))
  user.positionName = position2Name(Number(user.position))
  return user
}
